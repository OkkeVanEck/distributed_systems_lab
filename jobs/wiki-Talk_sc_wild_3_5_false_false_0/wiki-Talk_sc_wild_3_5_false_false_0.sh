#!/usr/bin/env bash
#SBATCH -J wiki-Talk_sc_wild_3_5_false_false_0
#SBATCH -o jobs/wiki-Talk_sc_wild_3_5_false_false_0/wiki-Talk_sc_wild_3_5_false_false_0.out
...
DATASET="wiki-Talk"
JOBNAME="wiki-Talk_sc_wild_3_5_false_false_0"
SCALE="3"
DO_STITCH="false"
RING_STITCH="false"
CONN="0.0"
