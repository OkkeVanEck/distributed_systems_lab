#!/usr/bin/env bash
#SBATCH -J wiki-Talk_scala_wild_2_3_true_true_01
#SBATCH -o jobs/wiki-Talk_scala_wild_2_3_true_true_01/wiki-Talk_scala_wild_2_3_true_true_01.out
...
DATASET="wiki-Talk"
JOBNAME="wiki-Talk_scala_wild_2_3_true_true_01"
SCALE="2"
DO_STITCH="true"
RING_STITCH="true"
CONN="0.1"
