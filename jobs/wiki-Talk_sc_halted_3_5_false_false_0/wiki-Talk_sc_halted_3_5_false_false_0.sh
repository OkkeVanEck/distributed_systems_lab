#!/usr/bin/env bash
#SBATCH -J wiki-Talk_sc_halted_3_5_false_false_0
#SBATCH -o jobs/wiki-Talk_sc_halted_3_5_false_false_0/wiki-Talk_sc_halted_3_5_false_false_0.out
...
DATASET="kgs"
JOBNAME="wiki-Talk_sc_halted_3_5_false_false_0"
SCALE="3"
DO_STITCH="true"
RING_STITCH="true"
CONN="0.1"
