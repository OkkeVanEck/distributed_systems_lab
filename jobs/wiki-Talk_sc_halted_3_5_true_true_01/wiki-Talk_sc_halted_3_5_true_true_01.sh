#!/usr/bin/env bash
#SBATCH -J wiki-Talk_sc_halted_3_5_true_true_01
#SBATCH -o jobs/wiki-Talk_sc_halted_3_5_true_true_01/wiki-Talk_sc_halted_3_5_true_true_01.out
...
DATASET="wiki-Talk"
JOBNAME="wiki-Talk_sc_halted_3_5_true_true_01"
SCALE="3"
DO_STITCH="true"
RING_STITCH="true"
CONN="0.1"
